import { ol_coordinate_equal, ol_coordinate_dist2d } from "./GeomUtils.js";
...
ol_geom_LineString.prototype.splitAt = function (pt, tol) {
  ...
  // Nothing to do
  if (
    ol_coordinate_equal(pt, this.getFirstCoordinate()) ||
  ...
  for (i = 0; i < c0.length - 1; i++) {
    ...
    // Test alignement
      ...
      if (c0[i][0] == c0[i + 1][0]) {
        ...
        var sum =
          ol_coordinate_dist2d(c0[i], pt) + ol_coordinate_dist2d(pt, c0[i + 1]);
